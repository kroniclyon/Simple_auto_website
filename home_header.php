...
<body>
      <header class="container-fluid  bg-light">
            <div class="rows">
                  <div class="col-sm-4">
                  <img class="img-circle" src="images/autoscanada2.jpg" width="200px" height="140px" style="margin-bottom:5px; margin-top: 30px;";>
...
<div class="topnav " id="myTopnav">
  ...
  <a class="btn btn-outline-info" href="about.php">About</a>
  <a class="btn btn-outline-info" href="contact.php">Contact</a>
  <a class="btn btn-outline-info" href="#">Automobiles</a>
